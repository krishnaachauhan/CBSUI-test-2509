      ...
      _fields: [
        ...
        },
        {
          ...
          shouldExclude(fieldData, dependentFieldsValues, formState) {
            ...
            const jointHolders = formState?.initialVal?.JOINT_HYPOTHICATION_DTL;
        ...
        },
        {
          ...
          accountTypeMetadata: {
            ...
            postValidationSetCrossFieldValues: async (
              ...
              if (
                currentField?.value &&
                !dependentFieldValues?.["JOINT_HYPOTHICATION_DTL.REF_BRANCH_CD"]
                  ?.value
              ) {
                let buttonName = await formState?.MessageBox({
          ...
          accountCodeMetadata: {
            ...
            postValidationSetCrossFieldValues: async (
              ...
              if (
                currentField?.value &&
                !dependentFieldsValues?.[
                  "JOINT_HYPOTHICATION_DTL.REF_ACCT_TYPE"
                ]?.value
              ) {
                let buttonName = await formState?.MessageBox({
                  messageTitle: "ValidationFailed",
                ...
                currentField?.value &&
                dependentFieldsValues?.["JOINT_HYPOTHICATION_DTL.REF_BRANCH_CD"]
                  ?.value &&
                dependentFieldsValues?.["JOINT_HYPOTHICATION_DTL.REF_ACCT_TYPE"]
                  ?.value
              ) {
                const reqParameters = {
                  COMP_CD: authState?.companyID ?? "",
                  ...
                  BRANCH_CD:
                    dependentFieldsValues?.[
                      "JOINT_HYPOTHICATION_DTL.REF_BRANCH_CD"
                    ]?.value ?? "",
        ...
        },
        {
          ...
          setValueOnDependentFieldsChange: (dependentFields) => {
            return dependentFields?.["JOINT_HYPOTHICATION_DTL.MEM_ACCT_CD"]
              ?.value;
          },
          validationRun: "all",
          postValidationSetCrossFieldValues: (
            ...
            if (
              field?.value &&
              dependentFields?.["JOINT_HYPOTHICATION_DTL.COPY_ACCT_NO"]
                ?.value &&
              field?.value ===
                dependentFields?.["JOINT_HYPOTHICATION_DTL.COPY_ACCT_NO"]?.value
            ) {
        ...
        },
        {
          ...
          setFieldLabel: (dependentValue) => {
            const custType =
              dependentValue?.["JOINT_HYPOTHICATION_DTL.CUSTOMER_TYPE"]
                ?.value ?? "";
            const gender =
              dependentValue?.["JOINT_HYPOTHICATION_DTL.GENDER"]?.value ?? "";
            if (Boolean(custType)) {
        ...
        },
        {
          ...
          postValidationSetCrossFieldValues: async (
            ...
            if (field?.value === "Y") {
              return {
                PIN_CODE: {
                  value: dependent?.["JOINT_HYPOTHICATION_DTL.PIN_CODE"]?.value,
                  ignoreUpdate: true,
                },
              };
            } else if (!dependent?.["JOINT_HYPOTHICATION_DTL.AREA_CD"]?.value) {
              return {
                PIN_CODE: {
                  value: "",
                  ignoreUpdate: true,
          ...
          postValidationSetCrossFieldValues: async (
            ...
            if (field?.value) {
              ...
              return {
                FLAG: {
                  value:
                    dependentFieldsValues?.["JOINT_HYPOTHICATION_DTL.FLAG"]
                      ?.value === "Y"
                      ? "Y"
                      : new Date(),
                },
        ...
        },
        {
          ...
          dependentFields: ["SR_CD", "JOINT_HYPOTHICATION_DTL"],
        ...
        },
        {
          ...
          label: "Security",
          options: (dependentValue, formState, _, authState) => {
            return API.getCollateralSecurityDataDDW({
              COMP_CD: authState?.companyID,
              BRANCH_CD: authState?.user?.branchCode,
            });
          },
          postValidationSetCrossFieldValues: async (
            ...
            if (currentField?.value) {
              return {
                SUB_TYPE: {
                  value: currentField?.optionData?.[0]?.SECURITY_TYPE ?? "",
                },
              };
            }
          },
