      ...
      _fields: [
        ...
        },
        {
          ...
          shouldExclude(fieldData, dependentFieldsValues, formState) {
            ...
            const jointHolders = formState?.initialVal?.JOINT_INTRODUCTOR_DTL;
        ...
        },
        {
          ...
          accountTypeMetadata: {
            ...
            postValidationSetCrossFieldValues: async (
              ...
              if (
                currentField?.value &&
                !dependentFieldValues?.["JOINT_INTRODUCTOR_DTL.REF_BRANCH_CD"]
                  ?.value
              ) {
                let buttonName = await formState?.MessageBox({
          ...
          accountCodeMetadata: {
            ...
            postValidationSetCrossFieldValues: async (
              ...
              if (
                currentField?.value &&
                !dependentFieldsValues?.["JOINT_INTRODUCTOR_DTL.REF_ACCT_TYPE"]
                  ?.value
              ) {
                let buttonName = await formState?.MessageBox({
                  messageTitle: "ValidationFailed",
                ...
                currentField?.value &&
                dependentFieldsValues?.["JOINT_INTRODUCTOR_DTL.REF_BRANCH_CD"]
                  ?.value &&
                dependentFieldsValues?.["JOINT_INTRODUCTOR_DTL.REF_ACCT_TYPE"]
                  ?.value
              ) {
                const reqParameters = {
                  ...
                  ACCT_TYPE:
                    dependentFieldsValues?.[
                      "JOINT_INTRODUCTOR_DTL.REF_ACCT_TYPE"
                    ]?.value ?? "",
                  ...
                  BRANCH_CD:
                    dependentFieldsValues?.[
                      "JOINT_INTRODUCTOR_DTL.REF_BRANCH_CD"
                    ]?.value ?? "",
        ...
        },
        {
          ...
          setValueOnDependentFieldsChange: (dependentFields) => {
            return dependentFields?.["JOINT_INTRODUCTOR_DTL.MEM_ACCT_CD"]
              ?.value;
          },
          validationRun: "all",
          postValidationSetCrossFieldValues: (
            ...
            if (
              field?.value &&
              dependentFields?.["JOINT_INTRODUCTOR_DTL.COPY_ACCT_NO"]?.value &&
              field?.value ===
                dependentFields?.["JOINT_INTRODUCTOR_DTL.COPY_ACCT_NO"]?.value
            ) {
        ...
        },
        {
          ...
          setFieldLabel: (dependentValue) => {
            const custType =
              ...
              "";
            const gender =
              dependentValue?.["JOINT_INTRODUCTOR_DTL.GENDER"]?.value ?? "";
            if (Boolean(custType)) {
        ...
        },
        {
          ...
          postValidationSetCrossFieldValues: async (
            ...
            if (field?.value === "Y") {
              return {
                PIN_CODE: {
                  value: dependent?.["JOINT_INTRODUCTOR_DTL.PIN_CODE"]?.value,
                  ignoreUpdate: true,
                },
              };
            } else if (!dependent?.["JOINT_INTRODUCTOR_DTL.AREA_CD"]?.value) {
              return {
                PIN_CODE: {
                  value: "",
                  ignoreUpdate: true,
          ...
          postValidationSetCrossFieldValues: async (
            ...
            if (field?.value) {
              ...
              return {
                FLAG: {
                  value:
                    dependentFieldsValues?.["JOINT_INTRODUCTOR_DTL.FLAG"]
                      ?.value === "Y"
                      ? "Y"
                      : new Date(),
                },
